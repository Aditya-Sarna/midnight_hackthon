...
const COPY: Record<UiLocale, PayCopy> = {
  "en": {
    "listening": "Listening",
    "listeningHint": "Pay someone · or say “borrow 1000” / “repay my loan”…",
    ...
    "unverifiedWarn": "This brand is in our catalog but is not registered with Circled’s verified-merchant registry. Proceed only if you trust this destination.",
    ...
    "accepting": "Accepting",
    "acceptingSub": "CircledProof · no OTP · Midnight attest",
    "paymentSent": "Payment sent",
    "declined": "Declined",
    "verified": "Verified",
    "voiceLowConfidence": "Speech unclear — verify amount and name before accepting",
    "confirmAgain": "Confirm again",
    "secondaryConfirmHint": "Large payment — tap Confirm again to authorize"
  },
  "hi": {
    ...
    "unverifiedWarn": "यह ब्रांड कैटलॉग में है, लेकिन Circled के सत्यापित व्यापारी रजिस्ट्री में पंजीकृत नहीं है। तभी आगे बढ़ें जब आप इस गंतव्य पर भरोसा करें।",
    ...
    "acceptingSub": "CircledProof · कोई OTP नहीं · Midnight प्रमाण",
  ...
  "es": {
    ...
    "unverifiedWarn": "Esta marca está en nuestro catálogo pero no está registrada en el registro de comercios verificados de Circled. Continúa solo si confías en este destino.",
    ...
    "accepting": "Aceptando",
    "acceptingSub": "CircledProof · sin OTP · attest Midnight",
  ...
  "fr": {
    ...
    "unverifiedWarn": "Cette marque est dans notre catalogue mais n’est pas inscrite au registre des marchands vérifiés Circled. Continuez seulement si vous faites confiance à cette destination.",
    ...
    "acceptingSub": "CircledProof · sans OTP · attestation Midnight",
  ...
  "de": {
    ...
    "unverifiedWarn": "Diese Marke ist im Katalog, aber nicht im verifizierten Händlerregister von Circled. Fahren Sie nur fort, wenn Sie dem Ziel vertrauen.",
    ...
    "acceptingSub": "CircledProof · kein OTP · Midnight-Attest",
  ...
  "pt": {
    ...
    "unverifiedWarn": "Esta marca está no catálogo, mas não está registrada no registro de comerciantes verificados da Circled. Continue só se confiar neste destino.",
    ...
    "accepting": "Aceitando",
    "acceptingSub": "CircledProof · sem OTP · atestado Midnight",
  ...
  "ar": {
    ...
    "unverifiedWarn": "هذه العلامة موجودة في الكتالوج لكنها غير مسجّلة في سجل التجار الموثّقين لدى Circled. تابع فقط إذا وثقت بهذا الوجهة.",
    ...
    "acceptingSub": "CircledProof · بدون OTP · إثبات Midnight",
  ...
  "ja": {
    ...
    "unverifiedWarn": "このブランドはカタログにありますが、Circledの確認済み加盟店レジストリには登録されていません。信頼できる場合のみ続行してください。",
    ...
    "accepting": "承認中",
    "acceptingSub": "CircledProof · OTPなし · Midnight証明",
    "paymentSent": "支払い完了",
    "declined": "拒否しました",
    "verified": "確認済み"
  },
  "zh": {
    ...
    "unverifiedWarn": "该品牌在目录中，但未在 Circled 已验证商户登记处注册。仅在信任此收款方时继续。",
    ...
    "accepting": "正在接受",
    "acceptingSub": "CircledProof · 无 OTP · Midnight 证明",
    "paymentSent": "付款已发送",
    "declined": "已拒绝",
    "verified": "已验证"
  },
  "ko": {
    ...
    "unverifiedWarn": "이 브랜드는 목록에 있지만 Circled 인증 가맹점 등록부에 없습니다. 신뢰할 때만 계속하세요.",
    ...
    "accepting": "수락 중",
    "acceptingSub": "CircledProof · OTP 없음 · Midnight 증명",
    "paymentSent": "결제 완료",
    "declined": "거절됨",
    "verified": "인증됨"
  },
  "it": {
    ...
    "unverifiedWarn": "Questo brand è nel catalogo ma non è registrato nel registro esercenti verificati Circled. Procedi solo se ti fidi di questa destinazione.",
    ...
    "acceptingSub": "CircledProof · senza OTP · attest Midnight",
  ...
  "nl": {
    ...
    "unverifiedWarn": "Dit merk staat in onze catalogus maar is niet geregistreerd in het geverifieerde handelaarsregister van Circled. Ga alleen door als je dit vertrouwt.",
    ...
    "acceptingSub": "CircledProof · geen OTP · Midnight-attest",
  ...
  "tr": {
    ...
    "unverifiedWarn": "Bu marka katalogda var ancak Circled doğrulanmış işyeri kaydında değil. Yalnızca güvendiğinizde devam edin.",
    ...
    "acceptingSub": "CircledProof · OTP yok · Midnight kanıt",
  ...
  "ru": {
    ...
    "unverifiedWarn": "Этот бренд есть в каталоге, но не зарегистрирован в реестре проверенных продавцов Circled. Продолжайте только если доверяете получателю.",
    ...
    "accepting": "Принятие",
    "acceptingSub": "CircledProof · без OTP · аттестация Midnight",
